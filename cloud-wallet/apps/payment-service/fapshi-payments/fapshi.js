...
const baseUrl = process.env.FAPSHI_BASEURL || 'https://live.fapshi.com'
const headers =  {
    apiuser: process.env.FAPSHI_APIUSER || 'replace_me_with_apiuser',
    apikey: process.env.FAPSHI_APIKEY || 'replace_me_with_apikey'
}
